...
You will find the family og all possible parabolas
$$
f(x) = a x^2 + b x + c
$$ 
...
1. For each pair of points, (a) create linear system that represents the problem (b) use RStudio to find the RREF of the augmented matrix for the system and (c) write down the general formula for the polynomial $f(x)$.
    1. $p_1 = (1,0)$ and $p_2 = (5,0)$


    2. $q_1= (1,-3)$ and $q_2 =  (5,10)$

2. Let $g_1(x)$ and $g_2(x)$ be two functions from the family in part 1.1: both contain the points $p_1$ and $p_2$. Show that  $g_1(x)  - g_2(x)$ is also a member of this $p_1,p_2$ family!
...
4. Now take a step back. I want you to make some observations about these two families, and the relation between them.  In particular:
    + What special property of the $p_1,p_2$ family leads to the nice behavior of part 3?
    + What **can** you say about the parabola $h_1(x) - h_2(x)$ in part 4?
