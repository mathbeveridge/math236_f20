...
* Find the best rank $k$ approximation of symmetric matrix $A$ (using its orthogonal diagonalization)
...
* Find the best rank $k$ approximation of a matrix $A$ (using its singular value decomposition)
...
* dot product of two vectors (aka scalar product, inner product)
...
* The spectral decomposition of a matrix allows us to find a rank $k$ approximation of a matrix
* The relative magnitudes of the eigenvectors/singular values indicate the quality of the rank $k$ approximation of the matrix
