...
2. Let $A$ be a $2 \times 2$ matrix. We view $A$ as a linear transformation from $\mathbb{R}^2$ to $\mathbb{R}^2$. Describe the eigenvalues for each of the following types of matrices.
    ...
    a. $A$ maps $\mathbb{R}^2$  onto a line through the origin in $\mathbb{R}^2$.
...
$$
  ...
  Let $\mathsf{v}_1 = \begin{bmatrix} 2 \\ 3 \end{bmatrix}$ and $\mathsf{v}_2 = \begin{bmatrix} 1 \\ -1 \end{bmatrix}$. For any constants $c_1, c_2$, we have
$$
