...
We have lots of 2D linear transformations. We can turn any of them into a 3D transformation by appending a row and a column of all zeros. For example, the 2D rotation
$$
\begin{bmatrix} \cos \theta & -\sin \theta~   \\ \sin \theta & \cos \theta \end{bmatrix} 
$$
becomes the 3D transformation
$$
\begin{bmatrix} \cos\theta & -\sin\theta~ & 0   \\ \sin\theta & \cos\theta  &0 \\ 0 & 0 & 0 \end{bmatrix}. 
$$
...
T \left( \begin{bmatrix} x \\ y \\ z \end{bmatrix} \right)
= 
\begin{bmatrix} \cos \frac{2\pi}{3} & -\sin\frac{2\pi}{3}~ & 0  \\ \sin\frac{2\pi}{3} & \cos\frac{2\pi}{3} & 0 \\ 0 & 0 & 0 \end{bmatrix} 
\begin{bmatrix} 1 & 0 & 3  \\ 0 & 1 & -4 \\ 0 & 0 & 1 \end{bmatrix} 
\begin{bmatrix} x \\ y \\ z \end{bmatrix}.
$$
...
Here is a picture of a grey house and a larger, upside-down orange house. **Work as a group** to reproduce this image using homogeneous coordinates. 
