...
a. Use RStudio to find the eigenvalues $a \pm bi$ and $c \pm di$, as well as "human friendly" eigenvectors $\mathsf{v}$ for $a - bi$ and $\mathsf{w}$ for $c - di$. 
...
and
$$
P = \begin{bmatrix} \mathrm{Re} (\mathsf{v}) & \mathrm{Im} (\mathsf{v}) &  \mathrm{Re} (\mathsf{w}) & \mathrm{Im}( \mathsf{w})  
\end{bmatrix}
$$
