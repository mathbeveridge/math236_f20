...
### The populations at $t=100$ versus the dominant eigenvector
 ...
 The following code compares your final population ratios to the dominant eigenvector ratios. What do you notice? Why does this make sense?

```{r}

finalpop = X[,N]
print(c('final population ratios:', finalpop/sum(finalpop)))

vec = eigen(L)$vectors[,1]
print(c('dominant eigenvector ratios:', vec/sum(vec)))
