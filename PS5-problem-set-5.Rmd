...
$$
V = \{ \mathsf{v}  \in \mathbb{R}^n\mid T(\mathsf{v})  = S(\mathsf{w}) \}.
$$
...
a.  Show that $\mathsf{w}_1, \mathsf{w}_2, \mathsf{w}_3$ are linearly independent.

b. Show that $\mathsf{w}_1, \mathsf{w}_2, \mathsf{w}_3$ span  $\mathbb{R}^3$.



## A Vector that is in Both $\mathrm{Col}(A)$ and $\mathrm{Nul}(A)$.
...
d. Consider  the vector $\mathsf{v}$ where
