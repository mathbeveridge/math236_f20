...
```
There are at least two important eigenvectors. After those two gaps, the eigenvalues taper off at a consisnt rate.


b. The first singular vector picks up a mild (but not definitive) layering of Republicans and Democrates. The second singular vector provides a clear separation!
