...
###
According to the [COVID Tracking Project](https://covidtracking.com/), there had been $54,463$ positive COVID-19 cases by 31 July, 2020. As of 16 December, 2020, that count has reached $386,412$. Here are the total number of new COVID-19 cases in Minnesota between August 1, 2020 and December 16, 2020.
...
```
a. Find the best fitting exponential function $f(t) = a e^{k t}$ for the number of new COVID-19 cases since 31 July, 2020.
...
record.party <- record[order(record$Party),]

A <- as.matrix(record.party[4:49])

partycolors = c(rep("blue",43), "purple", rep("red", 55))
...
b. Define `U` to be the matrix of right singular vectors. Plot the important singular vectors one by one. Here is a command to plot the first singular vector: ``plot(U[,1],pch=19,cex=.5,col=partycolors)`. The parties will be separated along the $x$-axis because we pre-sorted them. Do any of the singular values distinguish Democrats from Republicans along the $y$-axis?
