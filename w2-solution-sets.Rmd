...
* Theorem 4 in Section 1.4 which says that the following are equivalent (they are all true or are all false) for an $n \times m$ matrix $A$
    * For each $b \in  \mathbb{R}^m$, the system $A x = b$ has a solution
